...
description = "Packages app-bundled Snap-O inspector frontends and discovery metadata."
...
allprojects {
    ...
    description = if (path == ":") rootProject.description else "Configures Node.js downloads for Snap-O inspectors."
