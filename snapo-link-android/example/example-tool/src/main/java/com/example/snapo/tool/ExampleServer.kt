...
internal fun exampleServer(): InspectorServer {
    val counter = MutableStateFlow(0L)
    return InspectorServer(SnapOInspector.ID) {
...
private fun fakeSnapshot(counter: Long) = """
    {"protocolVersion":${SnapOInspector.PROTOCOL_VERSION},"revision":$counter,"items":[
