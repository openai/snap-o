pluginManagement {
    ...
    plugins {
        id("com.openai.snapo.inspector") version providers.gradleProperty("snapoVersion").get()
        id("com.openai.snapo.inspector-settings") version providers.gradleProperty("snapoVersion").get()
    }
}
