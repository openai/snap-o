...
/** Limits and accepted request forms for an inspector's endpoints. */
data class InspectorHttpRequestPolicy(
...
data class InspectorHttpRequest(
    val method: String,
    ...
    fun bodyText(): String = body.decodeToString(throwOnInvalidSequence = true)

    companion object {
        fun read(
            input: InputStream,
            policy: InspectorHttpRequestPolicy = InspectorHttpRequestPolicy(),
        ): InspectorHttpRequest {
            ...
            InspectorBrowserAccess.origin(headers)
            ...
            return InspectorHttpRequest(first[0], first[1], headers, body)
        }
        ...
        private fun readHead(input: InputStream): String {
            ...
            throw InspectorHttpException(400, "HTTP headers are too large")
        }
        ...
        private fun bodyLength(
            ...
            policy: InspectorHttpRequestPolicy,
        ): Int {
            ...
            if (length > policy.maxBodyBytes) throw InspectorHttpException(413, "The request body is too large")
