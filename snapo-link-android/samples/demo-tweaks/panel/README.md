...
This is only a demo, not part of the feature or the expected way to use it. You do not need this inspector. Any tool can use `/.snap-o/info`, `/tweaks`, `/tweaks?include=adjusted`, and `/tweaks/events` to build its own live UI.
