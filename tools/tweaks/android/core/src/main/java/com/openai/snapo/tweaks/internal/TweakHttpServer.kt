...
import com.openai.snapo.tool.ToolHttpException as HttpFailure
import com.openai.snapo.tool.ToolHttpRequest as HttpRequest
import com.openai.snapo.tool.ToolHttpResponse as HttpResponse
...
internal class TweakHttpServer(
    ...
    private suspend fun ToolCall.streamTweaks() {
    ...
    private fun ToolSseSession.sendTweaks(tweaks: List<TweakSnapshot>) {
