...
object SnapOTweaks {
    ...
    /** Updates an active tweak through the same registry used by the host tool. */
    ...
    /** Resets an active tweak through the same registry used by the host tool. */
...
internal fun TweakDescriptor.toSnapOTweakValue(value: Any): SnapOTweakValue = when (type) {
    ...
    TweakType.BEZIER -> SnapOTweakValue.Curve(value as BezierCurve)
