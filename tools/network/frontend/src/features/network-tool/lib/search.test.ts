...
import type { ToolRecord, RequestRecord, WebSocketRecord } from "../../../network/cdp";
import { matchesNetworkSearch, parseNetworkSearchQuery } from "./search";

describe("network tool search", () => {
...
function webSocket(overrides: Partial<WebSocketRecord> = {}): ToolRecord {
  return {
    kind: "websocket",
    processId,
    socketId: "socket",
