...
final class PluginResources {
    ...
    static JSONObject readPlugin(
        ...
        try (XmlResourceParser xml = app.loadXmlMetaData(pm, key)) {
            if (xml == null) throw new IllegalArgumentException("Missing tool XML resource.");
            int event;
            ...
            if (event != XmlPullParser.START_TAG || !"inspector".equals(xml.getName())
                ...
                throw new IllegalArgumentException("Unsupported tool descriptor.");
            }
            ...
            if (xml.getAttributeValue(null, "frontendAssets") != null) {
                ...
                if (!FrontendAssets.validPath(assetPath) || hostApiVersion < 1) {
                    throw new IllegalArgumentException("Invalid tool frontend.");
                }
