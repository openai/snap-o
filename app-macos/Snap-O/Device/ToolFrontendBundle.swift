...
public struct ToolFrontendBundle: Sendable {
  ...
  static func request(manifest: ToolProcessMetadata, tool: ToolDescriptor) throws -> Data {
  ...
  static func request(identity: ToolProcessIdentity, tool: ToolDescriptor) throws -> Data {
