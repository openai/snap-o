...
/** All records emitted over the wire for the network inspector feature. */
@Serializable
...
data class RequestWillBeSent(
    ...
    // NOTE: The Android side currently uses `body` for the request body preview.
    // Older builds may have emitted `bodyPreview`; the desktop should treat either as a preview.
