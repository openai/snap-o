...
Try shared state and delays with the [route examples](https://github.com/openai/snap-o/blob/9.0.0/examples/routes.py) and the [OkHttp and Ktor Tasks demos](https://github.com/openai/snap-o/blob/9.0.0/examples/android/README.md). See the [handler API reference](https://github.com/openai/snap-o/blob/9.0.0/skills/snap-o-network-inspector/references/interception.md) and [interception protocol](https://github.com/openai/snap-o/blob/9.0.0/contracts/network/interception.md) for more details.
