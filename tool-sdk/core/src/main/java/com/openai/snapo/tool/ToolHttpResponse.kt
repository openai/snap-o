...
data class ToolHttpResponse(
    ...
    companion object {
        fun json(json: String, statusCode: Int = 200): ToolHttpResponse =
            ToolHttpResponse(statusCode, json.toByteArray(Charsets.UTF_8))

        fun text(text: String, statusCode: Int = 200): ToolHttpResponse =
            ToolHttpResponse(
                statusCode,
        ...
        internal fun writeHead(output: OutputStream, statusCode: Int, headers: Map<String, String>) {
