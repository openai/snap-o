...
Concrete plugins live in [`plugins/`](../plugins/README.md). The independent [`examples/plugin/`](../examples/plugin/README.md) project demonstrates authoring with published package artifacts.
