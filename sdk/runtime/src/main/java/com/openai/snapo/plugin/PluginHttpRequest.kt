...
/** Limits and accepted request forms for an plugin's endpoints. */
data class PluginHttpRequestPolicy(
...
data class PluginHttpRequest(
    ...
    companion object {
        fun read(
            input: InputStream,
            policy: PluginHttpRequestPolicy = PluginHttpRequestPolicy(),
        ): PluginHttpRequest {
            ...
            PluginBrowserAccess.origin(headers)
            ...
            return PluginHttpRequest(first[0], first[1], headers, body)
        }
        ...
        private fun readHead(input: InputStream): String {
            ...
            throw PluginHttpException(400, "HTTP headers are too large")
        }
        ...
        private fun bodyLength(
            ...
            policy: PluginHttpRequestPolicy,
        ): Int {
            ...
            if (length > policy.maxBodyBytes) throw PluginHttpException(413, "The request body is too large")
