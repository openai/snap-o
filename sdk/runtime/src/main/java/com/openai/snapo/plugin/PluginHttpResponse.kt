...
data class PluginHttpResponse(
    ...
    companion object {
        fun json(json: String, statusCode: Int = 200): PluginHttpResponse =
            PluginHttpResponse(statusCode, json.toByteArray(Charsets.UTF_8))

        fun text(text: String, statusCode: Int = 200): PluginHttpResponse =
            PluginHttpResponse(
                statusCode,
        ...
        fun error(statusCode: Int, message: String, allowedMethods: String? = null): PluginHttpResponse =
            PluginHttpResponse(
                statusCode,
