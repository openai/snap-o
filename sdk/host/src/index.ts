...
interface HostState {
  ...
  inspector?: PluginDescriptor | null;
}
...
export class PluginHost extends EventTarget implements Host {
  ...
  get plugin(): PluginDescriptor | null {
    void this.start().catch(() => {});
...
export const host: Host = new PluginHost();
