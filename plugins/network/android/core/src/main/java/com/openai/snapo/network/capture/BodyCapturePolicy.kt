...
fun resolveResponseBody(
    ...
    val body = retainedBodyBytes.encodeForTool(likelyText, charset)
    val preview = previewSource.encodeForTool(likelyText, charset)
...
private fun ByteArray.encodeForTool(likelyText: Boolean, charset: Charset): String? = when {
    isEmpty() -> null
