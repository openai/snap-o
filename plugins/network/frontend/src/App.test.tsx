...
import { PluginHost, type Host, type ProcessManifest, type PluginDescriptor } from "@snap-o/plugin-host";
import { App } from "./App";
...
vi.mock("@snap-o/plugin-host", async (original) => ({
  ...(await original<typeof import("@snap-o/plugin-host")>()),
  get host() {
    return mocks.host;
  }
}));
