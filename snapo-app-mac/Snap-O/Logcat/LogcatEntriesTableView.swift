...
extension LogcatEntriesTableView {
  ...
  final class Coordinator: NSObject, NSTableViewDataSource, NSTableViewDelegate {
    ...
    @objc
    private func copyCellValue(_ sender: NSMenuItem) {
    ...
    @objc
    private func hideColumnFromRowMenu(_ sender: NSMenuItem) {
    ...
    @objc
    private func applyFilterMenuItem(_ sender: NSMenuItem) {
    ...
    @objc
    private func clipViewDidChangeBounds(_ notification: Notification) {
      handleScrollInteraction()
    }

    @objc
    private func columnDidResize(_ notification: Notification) {
      guard isSoftWrapEnabled,
            let tableView,
