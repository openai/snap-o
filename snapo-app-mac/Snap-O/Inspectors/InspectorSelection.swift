...
struct InspectorSelection {
  ...
  private var kind: InspectorID?
  private var current: SelectedAppInspector?
  private var retained: [InspectorID: SelectedAppInspector] = [:]
  ...
  private mutating func selectKind(_ app: InspectableApp, kind: InspectorID) {
    startupSelectionPending = false
  ...
  private mutating func updateTarget(_ app: InspectableApp) {
    var options: [InspectorID: AppInspectorOption] = [:]
  ...
  private mutating func remember(_ app: InspectableApp, kind: InspectorID) {
